...
export const INITIAL_TEMPLATES: Omit<Template, 'id'>[] = [
  {
    name: "Full Body A (Majestic)",
    order: 1,
    createdAt: Date.now(),
    entries: [
      ...
      { movementName: "Overhead Press", reps: 10, weight: 20, unit: "kg" },
    ]
  },
  {
    name: "Full Body B (Majestic)",
    order: 2,
    createdAt: Date.now(),
    entries: [
      { movementName: "Deadlift", reps: 5, weight: 80, unit: "kg" },
      { movementName: "Pull-Up", reps: 8, weight: 0, unit: "kg" },
      { movementName: "Incline Dumbbell Press", reps: 10, weight: 20, unit: "kg" },
      { movementName: "Lateral Raise", reps: 12, weight: 8, unit: "kg" },
    ]
  },
  {
    name: "Full Body C (Majestic)",
    order: 3,
    createdAt: Date.now(),
    entries: [
      { movementName: "Romanian Deadlift", reps: 10, weight: 50, unit: "kg" },
      { movementName: "Leg Press", reps: 12, weight: 100, unit: "kg" },
      { movementName: "Dumbbell Row", reps: 10, weight: 24, unit: "kg" },
      { movementName: "Dumbbell Shoulder Press", reps: 10, weight: 18, unit: "kg" },
    ]
  }
];
